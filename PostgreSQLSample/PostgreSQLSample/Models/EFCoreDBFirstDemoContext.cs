...
namespace PostgreSQLSample.Models.DB
{
    public partial class EFCoreDBFirstDemoContext : DbContext
    {
        public virtual DbSet<CabDB> Student { get; set; }
...
: base(options)
        ...
        //{
        //    optionsBuilder.UseNpgsql("ConnectionStrings.EFCoreDBFirstDemoDatabase", builder =>
        //    {
        ...
        {
            modelBuilder.Entity<CabDB>(entity =>
            {
